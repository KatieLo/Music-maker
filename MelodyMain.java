...
public class MelodyMain implements ActionListener, StdAudio.AudioEventListener {
	...
	private void createComponents() {
		...
		frame = new JFrame("CS 106A Melody Player");
		...
		statusLabel = new JLabel("Welcome to the CS 106A Melody Player!");
		...
		changeDurationButton = GuiUtils.createButton("Change", icon + "lightning.gif", 'h', this);
	...
	private void doLayout() {
		...
		try {
			ImageIcon logoIcon = new ImageIcon(ResourceUtils.filenameToURL(RESOURCE_FOLDER
